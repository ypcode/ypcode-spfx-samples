...
import styles from './TutoTest.module.scss';
import { ITutoTestProps } from './ITutoTestProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { CommandBar, ICommandBarItemProps, MarqueeSelection, DetailsList, DetailsListLayoutMode, IColumn, Selection, SelectionMode } from "office-ui-fabric-react";

import { mergeStyleSets } from 'office-ui-fabric-react/lib/Styling';

import { Tutorial, ITutorial } from "../../../ui-fabric-tutorial";
...
export default class TutoTest extends React.Component<ITutoTestProps, IDetailsListDocumentsExampleState> {

  private _selection: Selection;
  private _allItems: IDocument[];

  constructor(props: ITutoTestProps) {
    super(props);
    ...
    const columns: IColumn[] = [
      ...
      },
      {
        ...
        data: 'number',
        onRender: (item: IDocument) => {
          return <span data-tutorial-anchor="dateModifiedColumn">{item.dateModified}</span>;
        },
        isPadded: true
      },
      {
        ...
        onColumnClick: this._onColumnClick,
        onRender: (item: IDocument) => {
          return <span data-tutorial-anchor="modifiedByColumn">{item.modifiedBy}</span>;
        },
        isPadded: true
      },
      {
        ...
        onColumnClick: this._onColumnClick,
        onRender: (item: IDocument) => {
          return <span data-tutorial-anchor="fileSizeColumn">{item.fileSize}</span>;
        }
      }
    ];
